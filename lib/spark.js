...
Spark.prototype.digitalRead = function(pin, callback) {
  ...
  var complete = function(err, data) {
    ...
    if (typeof(data) === 'object' && data.return_value) {
      ...
      if ('function' === typeof(callback)) { callback(err, value); }
    }
  };
...
Spark.prototype.digitalWrite = function(pin, value) {
  ...
  console.log('digitalWrite:', params);
...
Spark.prototype.servoWrite = function(pin, value) {
  ...
  pin = SERVO_PINS[pin];
  var param = pin + ',' + value;
  console.log('Servo params:', param);
  this.analogWrite(pin, value, function(err, data) {
    console.log('err: ', err);
