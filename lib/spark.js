...
Spark.prototype.digitalWrite = function(pin, value) {
  ...
  console.log('DW uri', uri);
  console.log('DW params', params);
...
Spark.prototype.analogWrite = function(pin, value, pwmType) {
  var uri = this.base + "analogwrite",
      params = this.params({ data: { params: pin + "," + pwmType + "," + value } });
...
Spark.prototype.pwmWrite = function(pin, value) {
  ...
  this.analogWrite(pin, value, 'A');
}

Spark.prototype.servoWrite = function(pin, value) {
  value = (value).toScale(0, 255);
  this.analogWrite(pin, value, 'S');
}
