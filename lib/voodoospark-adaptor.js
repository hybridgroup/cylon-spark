...
VoodooSpark.prototype.servoWrite = function(pin, value, callback) {
 this._write("servo", this.board.MODES.SERVO, 180, pin, value);
};

VoodooSpark.prototype._write = function(type, mode, scale, pin, value, callback) {
  ...
  this.respond(mode + "Write", callback, null, pin, value);
};
